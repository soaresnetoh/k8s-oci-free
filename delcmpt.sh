delcmpt(){
    ...
    OCI_TENANCY_NAME=ascodigital

    # OCI_TENANCY_OCID=<tenancy ocid>
    OCI_TENANCY_OCID=ocid1.tenancy.oc1..aaaaaaaakoqjhfmcoie5hi33rtlxtdu5ku725gj6dlpppp3axraeqqgkq3gq
    ...
    declare -a region_codes={"SJC" "PHX" "IAD" "BOM"} # list of region codes where cmpt resources exists
